 ...
 */
public class FilmeDetalhes implements Serializable
{
    ...
    @Expose
    private DescricaoFilme belongsToCollection;
    @SerializedName("budget")
    @Expose
    private Integer budget;
    @SerializedName("genres")
    @Expose
    private List<GeneroFilme> genres = new ArrayList<GeneroFilme>();
    ...
    private final static long serialVersionUID = 1219974054362949931L;
